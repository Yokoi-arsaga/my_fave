...
class ChangeRegistrationToGrandchildFolder
{
    /**
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $parentFolderCount = GrandchildFolder::where('user_id', Auth::id())->count();
        $destinationFolder = GrandchildFolder::where('user_id', Auth::id())->get();
