...
Route::prefix('favorite')->name('favorite.')->group(function () {
    ...
    Route::prefix('/folder')->name('folder.')->group(function () {
        ...
        Route::prefix('/parent')->name('parent.')->group(function () {
            ...
            Route::post('/multi/register/{parentFolderId}', [ParentFolderController::class, 'multiRegisterFavoriteVideos'])->middleware(['auth:sanctum', 'favorite.register', 'register.to.parent'])->name('multi.register');
        ...
        Route::prefix('/child')->name('child.')->group(function (){
            ...
            Route::post('/multi/register/{childFolderId}', [ChildFolderController::class, 'multiRegisterFavoriteVideos'])->middleware(['auth:sanctum', 'favorite.register', 'register.to.child'])->name('multi.register');
        ...
        Route::prefix('/grandchild')->name('grandchild.')->group(function (){
            ...
            Route::post('/multi/register/{grandchildFolderId}', [GrandchildFolderController::class, 'multiRegisterFavoriteVideos'])->middleware(['auth:sanctum', 'favorite.register', 'register.to.grandchild'])->name('multi.register');
